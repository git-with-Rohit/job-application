...
// import { initIconMovement } from '../utils/moveIcons';
...
//         <img src={nodeIcon} className="icon" alt="Node.js Icon" />
//         <img src={awsIcon} className="icon" alt="AWS Icon" />
//         <img src={jsIcon} className="icon" alt="JavaScript Icon" />
//         <img src={cssIcon} className="icon" alt="CSS Icon" />
//         <img src={cppIcon} className="icon" alt="C++ Icon" />
//         <img src={dockerIcon} className="icon" alt="Docker Icon" />
//         <img src={gitIcon} className="icon" alt="Git Icon" />
//         <img src={pythonIcon} className="icon" alt="Python Icon" />
//         <img src={sqlIcon} className="icon" alt="SQL Icon" />
//       </div>
//       <div className="cover-letter">
//         <h2>Cover Letter</h2>
//         <p>Dear JP Media Team,</p>
//         <p>
//           I am writing to express my enthusiasm for the Full-Stack JavaScript Developer position at JP Media. 
//           With over four years of experience in full-stack development using technologies such as React, Node.js, and AWS, 
//           I am confident in my ability to contribute effectively to your team. My experience includes developing scalable web applications, 
//           optimizing performance, and collaborating with cross-functional teams to deliver high-quality solutions. 
//           I am particularly drawn to JP Media's innovative approach and commitment to excellence.
//         </p>
//         <p>
//           I look forward to the opportunity to discuss how my skills and experiences align with the goals of JP Media. 
//           Thank you for considering my application.
//         </p>
//         <p>Best regards,</p>
//         <p>Rohit Kumar</p>
//         <button onClick={showResume}>Open Resume</button>
//       </div>
//     </div>
//   );
// };
